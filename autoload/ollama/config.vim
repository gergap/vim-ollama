...
\ 'ollama_extract_max_size': 'Maximum uncompressed archive extraction size in bytes.',
...
\ 'ollama_bwrap_execute_allow_project_write': 'Allow sandboxed execute to write project files.',
