...
For CMake based projects, never bypass CMake by creating Makefiles from scratch!

### Vim-Ollama Track Changes

Track all changes in Git.
If a git repo does not exist yet create a local repo using `git_init` tool.
If no .gitignore exists yet create one and add it to get. It should contain
